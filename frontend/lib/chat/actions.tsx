...
async function submitUserMessage(content: string) {
  ...
  const result = await streamUI({
    ...
    system: `\
    # KeyRing GPT: Your AI Smart Contract Assistant

    You are **KeyRing GPT**, an AI assistant specialized in writing and deploying smart contracts using **Solidity (>=0.8.0 <0.9.0)**.
